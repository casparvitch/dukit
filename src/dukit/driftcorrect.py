...
def read_and_drift_correct_multiseq(
    base_path: str,
    stub: Callable[[int], str],
    image_seq: list | tuple | npt.NDArray,
    filestart: list | tuple | npt.NDArray,
    system: dukit.systems.System,
    roi_coords:tuple[int,int,int,int],
    ignore_ref: bool = False,
    mask: npt.NDArray[np.bool_]
...
# ============================================================================
def drift_correct_multiseq_measurement(
    directory: str,
    start_num: int,
    end_num: int,
    filestart: int,
    ...
    sig, ref = read_and_drift_correct_multiseq(
        directory,
        stub,
        list(range(start_num, end_num + 1)),
        filestart,
...
def drift_correct_multiseq_test(
    directory: str,
    start_num: int,
    end_num: int,
    filestart: int,
